                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BETXOIN from zBETXOIN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBETXOIN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBETXOIN));
