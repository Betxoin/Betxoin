                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BETXOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BETXOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and betxoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBETXOIN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BETXOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about BETXOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BETXOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BETXOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BETXOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a BETXOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BETXOIN Core help message to get a list with possible BETXOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BETXOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BETXOIN network", "", count));
}
...
{
    QString strTitle = tr("BETXOIN Core"); // default title
...
/** Creates context menu, its actions, and betxoins up all the relevant signals for mouse events. */
