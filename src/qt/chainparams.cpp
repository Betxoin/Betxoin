...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("46.161.39.101", "46.161.39.101"));   // Single node address
        vSeeds.push_back(CDNSSeedData("95.179.157.176", "95.179.157.176"));       // Single node address
        vSeeds.push_back(CDNSSeedData("45.32.99.206", "45.32.99.206"));   // Single node address
        vSeeds.push_back(CDNSSeedData("45.32.214.138", "45.32.214.138"));       // Single node address
