...
public:
    ...
    void setZBETXOINControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBETXOIN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBETXOIN_clicked();
    void on_pushButtonZBETXOINControl_clicked();
