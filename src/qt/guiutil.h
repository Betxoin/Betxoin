...
/** Utility functions used by the BETXOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render BETXOIN addresses in monospace font
...
// Parse "betxoin:" URI into recipient object, return true on successful parsing
