...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "BETXOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BETXOIN features */
        {"betxoin", "masternode", &masternode, true, true, false},
        {"betxoin", "listmasternodes", &listmasternodes, true, true, false},
        {"betxoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"betxoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"betxoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"betxoin", "masternodedebug", &masternodedebug, true, true, false},
        {"betxoin", "startmasternode", &startmasternode, true, true, false},
        {"betxoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"betxoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"betxoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"betxoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"betxoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"betxoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"betxoin", "mnbudget", &mnbudget, true, true, false},
        {"betxoin", "preparebudget", &preparebudget, true, true, false},
        {"betxoin", "submitbudget", &submitbudget, true, true, false},
        {"betxoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"betxoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"betxoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"betxoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"betxoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"betxoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"betxoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"betxoin", "checkbudgets", &checkbudgets, true, true, false},
        {"betxoin", "mnsync", &mnsync, true, true, false},
        {"betxoin", "spork", &spork, true, true, false},
        {"betxoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"betxoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use betxoind, or the -server option to betxoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> betxoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30400/\n";
}
