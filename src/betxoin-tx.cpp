...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BETXOIN Core betxoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  betxoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded betxoin transaction") + "\n" +
                               "  betxoin-tx [options] -create [commands]   " + _("Create hex-encoded betxoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded betxoin transaction
