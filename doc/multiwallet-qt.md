...
In order to support loading of multiple wallets in betxoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is betxoin.cpp.
...
Changes to betxoin.cpp
----------------------
betxoin.cpp is the entry point into betxoin-qt, and as such, will require some minor modifications to provide hooks for
