...
This means one can have an always-on betxoind instance running, and another local betxoind/betxoin-qt instance which connects to this node and receives blocks from it.
