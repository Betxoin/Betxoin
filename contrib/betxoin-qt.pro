...
RESOURCES += src/qt/betxoin.qrc src/qt/betxoin_locale.qrc

TRANSLATIONS += src/qt/locale/betxoin_bg.ts \
                src/qt/locale/betxoin_de.ts \
                src/qt/locale/betxoin_en.ts \
                src/qt/locale/betxoin_es.ts \
                src/qt/locale/betxoin_fi.ts \
                src/qt/locale/betxoin_fr.ts \
                src/qt/locale/betxoin_it.ts \
                src/qt/locale/betxoin_ja.ts \
                src/qt/locale/betxoin_pl.ts \
                src/qt/locale/betxoin_pt.ts \
                src/qt/locale/betxoin_ru.ts \
                src/qt/locale/betxoin_sk.ts \
                src/qt/locale/betxoin_sv.ts \
                src/qt/locale/betxoin_vi.ts \
                src/qt/locale/betxoin_zh_CN.ts \
                src/qt/locale/betxoin_zh_TW.ts
