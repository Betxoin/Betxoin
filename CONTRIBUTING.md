Contributing to BETXOIN Core
============================

The BETXOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BETXOIN Core project, and is not to be
confused with overall BETXOIN Network Protocol consensus changes.

Whether a pull request is merged into BETXOIN Core rests with the project merge
...
Patches that change BETXOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the BETXOIN consensus, it must have been
...
The project leader is the release manager for each BETXOIN Core release.
